...
import org.ncic.bioinfo.sparkseq.algorithms.utils.LRUCache;
...
public class MathUtils {
    ...
    public static int randomIntegerInRange( final int min, final int max ) {
        return RandomGenerator.getRandomGenerator().nextInt(max - min + 1) + min;
    }
    ...
    static public ArrayList<Integer> sampleIndicesWithReplacement(final int n, final int k) {
        ...
        for (int i = 0; i < k; i++) {
            ...
            chosen_balls.add(RandomGenerator.getRandomGenerator().nextInt(n));
    ...
    static public ArrayList<Integer> sampleIndicesWithoutReplacement(final int n, final int k) {
        ...
        Collections.shuffle(chosen_balls, RandomGenerator.getRandomGenerator());
